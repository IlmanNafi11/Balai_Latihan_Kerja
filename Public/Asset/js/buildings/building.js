...
function updateTable(buildings) {
        ...
        buildings.forEach((row, index) => {
            ...
            tr.innerHTML = `
                ...
                <td class="d-flex row-gap-2 column-gap-2 pe-3 table-data-actions">
                    ...
                    <button class="btn btn-danger d-flex align-items-center column-gap-1" onclick="deleteBuilding(${row.id})">
