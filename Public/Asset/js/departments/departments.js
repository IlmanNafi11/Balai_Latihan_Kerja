        ...
        departments.forEach((row, index) => {
            ...
            tr.innerHTML = `
                ...
                <td class="d-flex row-gap-2 column-gap-2 pe-3 table-data-actions">
                    <a href="/department/update/${row.id}">
                    ...
                    <button class="btn btn-danger d-flex align-items-center column-gap-1" onclick="deleteDepartments(${row.id})">
