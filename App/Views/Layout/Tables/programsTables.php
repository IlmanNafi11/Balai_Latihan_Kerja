        ...
        <table class="table table-hover align-middle">
            ...
            <?php if (!empty($programs)) {
                ...
                foreach ($programs as $program):
                    ?>
                    <tr id="row-<?php echo $program['id'] ?>">
                        <td><?php echo $no ?></td>
                        <td><?= $program['nama'] ?></td>
                        <td><?= $program['department_name'] ?></td>
                        <td><?= $program['instructor_name'] ?></td>
                        <td><?= $program['building_name'] ?></td>
                        <td><?= $program['jml_peserta'] ?></td>
                        <td class="d-flex row-gap-2 column-gap-2 flex-wrap">
                            <a href="/programs/updatePrograms/<?php echo $program['id'] ?>">
                                <button
                            ...
                            <button class="btn btn-danger d-flex align-items-center column-gap-1" onclick="deletePrograms(<?php echo $program['id'] ?>)">
                                <svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor"
