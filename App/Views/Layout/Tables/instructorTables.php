<div class="tables tables-program-container px-0 m-0">
    ...
    <div class="button-add-data-container">
        <a href="/instructor/addInstructor"><button class="btn btn-primary">+ Tambah Data</button></a>
    </div>
    <!-- Table -->
            ...
            <?php if (!empty($instructors)){
                ...
                <tr>
                    ...
                    <td class="d-flex row-gap-2 column-gap-2 flex-wrap">
                        <a href="/instructor/updateInstructor/<?php echo $instructor['id']?>"><button
                        ...
                        <button onclick="deleteInstructor(<?php echo $instructor['id']?>)" class="btn btn-danger d-flex align-items-center column-gap-1"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
