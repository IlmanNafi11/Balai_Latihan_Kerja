        ...
        <form class="d-flex flex-column h-auto form-control">
            <div class="form-instruktor-container container-form-input d-flex column-gap-4 row-gap-3 w-100 h-auto">
                <div class="input-pesan-notifikasi input-deskripsi-form w-100 h-auto">
                    ...
                    <textarea name="pesan-notifikasi" id="pesan-notifikasi" class="form-control"
                              placeholder="Contoh : Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."></textarea>
...
<!-- Logic Handler -->
<script type="module" src="/Asset/js/notifications/addNotifications.js"></script>
