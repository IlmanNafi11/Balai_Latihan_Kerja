...
<div class="container-fluid main-root-container w-100 h-100 p-0 m-0">
    ...
    <div class="container-fluid container-content d-flex flex-column h-auto">
        ...
        <!-- Form -->
        <form class="d-flex flex-column h-auto form-program form-control" id="form-update-programs">
            <div class="form-program-container row row-gap-3 h-100 w-100">
                <!-- Form input 1 -->
                <div class="container-form-input col-md-6 d-flex flex-column row-gap-3">
                    ...
                    <div class="input-alat">
                        <label for="select-alat" class="form-label">Alat</label>
                        <select class="form-select select-alat" name="select-alat" id="multiple-select-field"
                                data-placeholder="Pilih Alat..." multiple>
                            <!-- Data Options -->
                        </select>
                        <div class="valid-feedback" id="valid-alat"></div>
                        <div class="invalid-feedback" id="invalid-alat"></div>
                    </div>
            ...
            <div
                ...
                <button class="btn btn-primary" id="btn-perbarui" type="button">Simpan</button>
                <a href="/programs">
